            ...
            <div className={classes.NavigationItems}>
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className={classes.SearchIcon} viewBox="0 0 32 32">
                        <circle className={classes.SearchIconBack} fill="none" cx="16" cy="16" r="16"/>
                        <path className={classes.SearchIconFront} fill="#3A2D80" d="M26.061 23.939l-5.23-5.231c.972-1.398 1.501-3.054 1.501-4.792 0-4.64-3.775-8.416-8.415-8.416-4.639 0-8.414 3.775-8.416 8.417.002 4.64 3.776 8.416 8.414 8.416l.003-1.5v1.5c1.739 0 3.395-.529 4.792-1.503l5.23 5.231c.292.293.676.439 1.06.439s.768-.146 1.061-.439c.585-.586.585-1.536 0-2.122zm-12.144-4.607h-.004c-2.983 0-5.411-2.43-5.413-5.416.002-2.986 2.431-5.416 5.416-5.416 2.986 0 5.415 2.429 5.415 5.416 0 1.447-.563 2.808-1.586 3.831-1.022 1.022-2.382 1.585-3.828 1.585z"/>
                    </svg>
                </Link>               
            </div> 
        );
