...
const lowerToolBar = (props) => (
    <nav className={classes.LowerToolBar}>
        <Link role="menuitem" aria-label="to blog home" to="/blog">
        ...
        <Link role="menuitem" aria-label="to popular blog" to="/blog/popular_blogposts">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <Link role="menuitem" aria-label="to latest blog" to="/blog/latest_blogposts">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
