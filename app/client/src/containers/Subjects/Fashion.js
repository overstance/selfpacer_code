...
class Fashion extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchFashion();
        this.props.onFetchAllFashion();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allFashionLoading && !this.props.fetchAllFashionResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllFashionResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allFashionLoading: state.clickedSubject.allLoading,
        fetchAllFashionResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchFashion: () => dispatch( actions.fetchFashion() ),

        onFetchAllFashion: () => dispatch( actions.fetchAllFashion() ),
...
Fashion.propTypes = {
    onFetchAllFashion: PropTypes.func.isRequired,
