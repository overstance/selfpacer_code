...
class Painting extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchPainting();
        this.props.onFetchAllPainting();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allPaintingLoading && !this.props.fetchAllPaintingResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllPaintingResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allPaintingLoading: state.clickedSubject.allLoading,
        fetchAllPaintingResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchPainting: () => dispatch( actions.fetchPainting() ),

        onFetchAllPainting: () => dispatch( actions.fetchAllPainting() ),
...
Painting.propTypes = {
    onFetchAllPainting: PropTypes.func.isRequired,
