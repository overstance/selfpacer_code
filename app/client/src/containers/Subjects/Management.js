...
class Management extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchManagement();
        this.props.onFetchAllManagement();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allManagementLoading && !this.props.fetchAllManagementResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllManagementResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allManagementLoading: state.clickedSubject.allLoading,
        fetchAllManagementResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchManagement: () => dispatch( actions.fetchManagement() ),

        onFetchAllManagement: () => dispatch( actions.fetchAllManagement() ),
...
Management.propTypes = {
    onFetchAllManagement: PropTypes.func.isRequired,
