...
class Data extends Component {
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allDataLoading && !this.props.fetchAllDataResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllDataResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allDataLoading: state.clickedSubject.allLoading,
        fetchAllDataResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onFetchAllData: () => dispatch( actions.fetchAllData() ),
...
Data.propTypes = {
    onFetchAllData: PropTypes.func.isRequired,
