...
class Pet extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchPet();
        this.props.onFetchAllPet();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allPetLoading && !this.props.fetchAllPetResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllPetResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allPetLoading: state.clickedSubject.allLoading,
        fetchAllPetResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchPet: () => dispatch( actions.fetchPet() ),

        onFetchAllPet: () => dispatch( actions.fetchAllPet() ),
...
Pet.propTypes = {
    onFetchAllPet: PropTypes.func.isRequired,
