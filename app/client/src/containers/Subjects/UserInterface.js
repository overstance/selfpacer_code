...
class Interface extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchInterface();
        this.props.onFetchAllInterface();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allInterfaceLoading && !this.props.fetchAllInterfaceResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllInterfaceResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allInterfaceLoading: state.clickedSubject.allLoading,
        fetchAllInterfaceResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchInterface: () => dispatch( actions.fetchInterface() ),

        onFetchAllInterface: () => dispatch( actions.fetchAllInterface() ),
...
Interface.propTypes = {
    onFetchAllInterface: PropTypes.func.isRequired,
