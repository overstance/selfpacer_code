...
class StudySkill extends Component {
    
   componentDidMount () {

        this.props.onFetchStudySkill();
        this.props.onFetchAllStudySkill();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allStudySkillLoading && !this.props.fetchAllStudySkillResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllStudySkillResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allStudySkillLoading: state.clickedSubject.allLoading,
        fetchAllStudySkillResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchStudySkill: () => dispatch( actions.fetchStudySkill() ),

        onFetchAllStudySkill: () => dispatch( actions.fetchAllStudySkill() ),
...
StudySkill.propTypes = {
    onFetchAllStudySkill: PropTypes.func.isRequired,
    subject: PropTypes.array.isRequired
};

export default connect( mapStateToProps, mapDispatchToProps )( StudySkill );
