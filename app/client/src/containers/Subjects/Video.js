...
class Video extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchVideo();
        this.props.onFetchAllVideo();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allVideoLoading && !this.props.fetchAllVideoResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllVideoResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allVideoLoading: state.clickedSubject.allLoading,
        fetchAllVideoResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchVideo: () => dispatch( actions.fetchVideo() ),

        onFetchAllVideo: () => dispatch( actions.fetchAllVideo() ),
...
Video.propTypes = {
    onFetchAllVideo: PropTypes.func.isRequired,
