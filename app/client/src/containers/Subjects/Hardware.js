...
class Hardware extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchHardware();
        this.props.onFetchAllHardware();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allHardwareLoading && !this.props.fetchAllHardwareResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllHardwareResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allHardwareLoading: state.clickedSubject.allLoading,
        fetchAllHardwareResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchHardware: () => dispatch( actions.fetchHardware() ),

        onFetchAllHardware: () => dispatch( actions.fetchAllHardware() ),
...
Hardware.propTypes = {
    onFetchAllHardware: PropTypes.func.isRequired,
