...
class Audio extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchAudio();
        this.props.onFetchAllAudio();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allAudioLoading && !this.props.fetchAllAudioResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllAudioResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allAudioLoading: state.clickedSubject.allLoading,
        fetchAllAudioResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchAudio: () => dispatch( actions.fetchAudio() ),

        onFetchAllAudio: () => dispatch( actions.fetchAllAudio() ),
...
Audio.propTypes = {
    onFetchAllAudio: PropTypes.func.isRequired,
