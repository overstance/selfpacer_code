...
class PersonalDev extends Component {
    
   componentDidMount () {

        this.props.onFetchPersonalDev();
        this.props.onFetchAllPersonalDev();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allPersonalDevLoading && !this.props.fetchAllPersonalDevResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllPersonalDevResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allPersonalDevLoading: state.clickedSubject.allLoading,
        fetchAllPersonalDevResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchPersonalDev: () => dispatch( actions.fetchPersonalDev() ),

        onFetchAllPersonalDev: () => dispatch( actions.fetchAllPersonalDev() ),
...
PersonalDev.propTypes = {
    onFetchAllPersonalDev: PropTypes.func.isRequired,
    subject: PropTypes.array.isRequired
};

export default connect( mapStateToProps, mapDispatchToProps )( PersonalDev );
