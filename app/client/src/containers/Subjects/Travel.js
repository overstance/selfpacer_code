...
class Travel extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchTravel();
        this.props.onFetchAllTravel();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allTravelLoading && !this.props.fetchAllTravelResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllTravelResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allTravelLoading: state.clickedSubject.allLoading,
        fetchAllTravelResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchTravel: () => dispatch( actions.fetchTravel() ),

        onFetchAllTravel: () => dispatch( actions.fetchAllTravel() ),
...
Travel.propTypes = {
    onFetchAllTravel: PropTypes.func.isRequired,
