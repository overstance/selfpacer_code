...
class Marketing extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchMarketing();
        this.props.onFetchAllMarketing();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allMarketingLoading && !this.props.fetchAllMarketingResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllMarketingResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allMarketingLoading: state.clickedSubject.allLoading,
        fetchAllMarketingResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchMarketing: () => dispatch( actions.fetchMarketing() ),

        onFetchAllMarketing: () => dispatch( actions.fetchAllMarketing() ),
...
Marketing.propTypes = {
    onFetchAllMarketing: PropTypes.func.isRequired,
