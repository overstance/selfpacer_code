...
class Animation extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchAnimation();
        this.props.onFetchAllAnimation();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allAnimationLoading && !this.props.fetchAllAnimationResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllAnimationResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allAnimationLoading: state.clickedSubject.allLoading,
        fetchAllAnimationResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchAnimation: () => dispatch( actions.fetchAnimation() ),

        onFetchAllAnimation: () => dispatch( actions.fetchAllAnimation() ),
...
Animation.propTypes = {
    onFetchAllAnimation: PropTypes.func.isRequired,
