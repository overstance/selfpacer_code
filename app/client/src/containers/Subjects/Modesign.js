...
class Modesign extends Component {
    
   componentDidMount () {

        this.props.onFetchModesign();
        this.props.onFetchAllModesign();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allModesignLoading && !this.props.fetchAllModesignResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllModesignResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allModesignLoading: state.clickedSubject.allLoading,
        fetchAllModesignResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchModesign: () => dispatch( actions.fetchModesign() ),

        onFetchAllModesign: () => dispatch( actions.fetchAllModesign() ),
...
Modesign.propTypes = {
    onFetchAllModesign: PropTypes.func.isRequired,
    subject: PropTypes.array.isRequired
};

export default connect( mapStateToProps, mapDispatchToProps )( Modesign );
