...
class Mobile extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchMobile();
        this.props.onFetchAllMobile();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allMobileLoading && !this.props.fetchAllMobileResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllMobileResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allMobileLoading: state.clickedSubject.allLoading,
        fetchAllMobileResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchMobile: () => dispatch( actions.fetchMobile() ),

        onFetchAllMobile: () => dispatch( actions.fetchAllMobile() ),
...
Mobile.propTypes = {
    onFetchAllMobile: PropTypes.func.isRequired,
