...
class Writing extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchWriting();
        this.props.onFetchAllWriting();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allWritingLoading && !this.props.fetchAllWritingResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllWritingResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allWritingLoading: state.clickedSubject.allLoading,
        fetchAllWritingResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchWriting: () => dispatch( actions.fetchWriting() ),

        onFetchAllWriting: () => dispatch( actions.fetchAllWriting() ),
...
Writing.propTypes = {
    onFetchAllWriting: PropTypes.func.isRequired,
