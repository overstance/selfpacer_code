...
class Home extends Component {
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allHomeLoading && !this.props.fetchAllHomeResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllHomeResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allHomeLoading: state.clickedSubject.allLoading,
        fetchAllHomeResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onFetchAllHome: () => dispatch( actions.fetchAllHome() ),
...
Home.propTypes = {
    onFetchAllHome: PropTypes.func.isRequired,
