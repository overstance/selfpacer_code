...
class Software extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchSoftware();
        this.props.onFetchAllSoftware();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allSoftwareLoading && !this.props.fetchAllSoftwareResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllSoftwareResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allSoftwareLoading: state.clickedSubject.allLoading,
        fetchAllSoftwareResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchSoftware: () => dispatch( actions.fetchSoftware() ),

        onFetchAllSoftware: () => dispatch( actions.fetchAllSoftware() ),
...
Software.propTypes = {
    onFetchAllSoftware: PropTypes.func.isRequired,
