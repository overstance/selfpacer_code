...
class Architecture extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchArchitecture();
        this.props.onFetchAllArchitecture();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allArchitectureLoading && !this.props.fetchAllArchitectureResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllArchitectureResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allArchitectureLoading: state.clickedSubject.allLoading,
        fetchAllArchitectureResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchArchitecture: () => dispatch( actions.fetchArchitecture() ),

        onFetchAllArchitecture: () => dispatch( actions.fetchAllArchitecture() ),
...
Architecture.propTypes = {
    onFetchAllArchitecture: PropTypes.func.isRequired,
