...
class Food extends Component {
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allFoodLoading && !this.props.fetchAllFoodResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllFoodResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allFoodLoading: state.clickedSubject.allLoading,
        fetchAllFoodResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onFetchAllFood: () => dispatch( actions.fetchAllFood() ),
...
Food.propTypes = {
    onFetchAllFood: PropTypes.func.isRequired,
