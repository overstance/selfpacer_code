...
class Network extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchNetwork();
        this.props.onFetchAllNetwork();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allNetworkLoading && !this.props.fetchAllNetworkResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllNetworkResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allNetworkLoading: state.clickedSubject.allLoading,
        fetchAllNetworkResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchNetwork: () => dispatch( actions.fetchNetwork() ),

        onFetchAllNetwork: () => dispatch( actions.fetchAllNetwork() ),
...
Network.propTypes = {
    onFetchAllNetwork: PropTypes.func.isRequired,
