...
class Interior extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchInterior();
        this.props.onFetchAllInterior();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allInteriorLoading && !this.props.fetchAllInteriorResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllInteriorResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allInteriorLoading: state.clickedSubject.allLoading,
        fetchAllInteriorResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchInterior: () => dispatch( actions.fetchInterior() ),

        onFetchAllInterior: () => dispatch( actions.fetchAllInterior() ),
...
Interior.propTypes = {
    onFetchAllInterior: PropTypes.func.isRequired,
