...
class Gaming extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchGaming();
        this.props.onFetchAllGaming();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allGamingLoading && !this.props.fetchAllGamingResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllGamingResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allGamingLoading: state.clickedSubject.allLoading,
        fetchAllGamingResourcesError: state.clickedSubject.fetchAllResourcesError,
...
Gaming.propTypes = {
    onFetchAllGaming: PropTypes.func.isRequired,
