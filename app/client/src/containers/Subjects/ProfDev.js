...
class ProfDev extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchProfDev();
        this.props.onFetchAllProfDev();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allProfDevLoading && !this.props.fetchAllProfDevResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllProfDevResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allProfDevLoading: state.clickedSubject.allLoading,
        fetchAllProfDevResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchProfDev: () => dispatch( actions.fetchProfDev() ),

        onFetchAllProfDev: () => dispatch( actions.fetchAllProfDev() ),
...
ProfDev.propTypes = {
    onFetchAllProfDev: PropTypes.func.isRequired,
    subject: PropTypes.array.isRequired
};

export default connect( mapStateToProps, mapDispatchToProps )( ProfDev );
