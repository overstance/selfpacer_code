...
class Beauty extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchBeauty();
        this.props.onFetchAllBeauty();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allBeautyLoading && !this.props.fetchAllBeautyResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllBeautyResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allBeautyLoading: state.clickedSubject.allLoading,
        fetchAllBeautyResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchBeauty: () => dispatch( actions.fetchBeauty() ),

        onFetchAllBeauty: () => dispatch( actions.fetchAllBeauty() ),
...
Beauty.propTypes = {
    onFetchAllBeauty: PropTypes.func.isRequired,
