...
class Gamedev extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchGamedev();
        this.props.onFetchAllGamedev();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allGamedevLoading && !this.props.fetchAllGamedevResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllGamedevResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allGamedevLoading: state.clickedSubject.allLoading,
        fetchAllGamedevResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchGamedev: () => dispatch( actions.fetchGamedev() ),

        onFetchAllGamedev: () => dispatch( actions.fetchAllGamedev() ),
...
Gamedev.propTypes = {
    onFetchAllGamedev: PropTypes.func.isRequired,
