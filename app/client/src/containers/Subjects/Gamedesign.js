...
class Gamedesign extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchGamedesign();
        this.props.onFetchAllGamedesign();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allGamedesignLoading && !this.props.fetchAllGamedesignResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllGamedesignResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allGamedesignLoading: state.clickedSubject.allLoading,
        fetchAllGamedesignResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchGamedesign: () => dispatch( actions.fetchGamedesign() ),

        onFetchAllGamedesign: () => dispatch( actions.fetchAllGamedesign() ),
...
Gamedesign.propTypes = {
    onFetchAllGamedesign: PropTypes.func.isRequired,
    subject: PropTypes.array.isRequired
};

export default connect( mapStateToProps, mapDispatchToProps )( Gamedesign );
