...
class RealEstate extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchRealEstate();
        this.props.onFetchAllRealEstate();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allRealEstateLoading && !this.props.fetchAllRealEstateResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllRealEstateResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allRealEstateLoading: state.clickedSubject.allLoading,
        fetchAllRealEstateResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchRealEstate: () => dispatch( actions.fetchRealEstate() ),

        onFetchAllRealEstate: () => dispatch( actions.fetchAllRealEstate() ),
...
RealEstate.propTypes = {
    onFetchAllRealEstate: PropTypes.func.isRequired,
