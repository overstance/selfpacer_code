...
class Photography extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchPhotography();
        this.props.onFetchAllPhotography();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allPhotographyLoading && !this.props.fetchAllPhotographyResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllPhotographyResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allPhotographyLoading: state.clickedSubject.allLoading,
        fetchAllPhotographyResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchPhotography: () => dispatch( actions.fetchPhotography() ),

        onFetchAllPhotography: () => dispatch( actions.fetchAllPhotography() ),
...
Photography.propTypes = {
    onFetchAllPhotography: PropTypes.func.isRequired,
