...
class Database extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchDatabase();
        this.props.onFetchAllDatabase();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allDatabaseLoading && !this.props.fetchAllDatabaseResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllDatabaseResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allDatabaseLoading: state.clickedSubject.allLoading,
        fetchAllDatabaseResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchDatabase: () => dispatch( actions.fetchDatabase() ),

        onFetchAllDatabase: () => dispatch( actions.fetchAllDatabase() ),
...
Database.propTypes = {
    onFetchAllDatabase: PropTypes.func.isRequired,
