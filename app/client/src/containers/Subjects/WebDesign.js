...
class WebDesign extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchWebDesign();
        this.props.onFetchAllWebDesign();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allWebDesignLoading && !this.props.fetchAllWebDesignResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllWebDesignResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allWebDesignLoading: state.clickedSubject.allLoading,
        fetchAllWebDesignResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchWebDesign: () => dispatch( actions.fetchWebDesign() ),

        onFetchAllWebDesign: () => dispatch( actions.fetchAllWebDesign() ),
...
WebDesign.propTypes = {
    onFetchAllWebDesign: PropTypes.func.isRequired,
