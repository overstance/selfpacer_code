...
class Graphics extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchGraphics();
        this.props.onFetchAllGraphics();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allGraphicsLoading && !this.props.fetchAllGraphicsResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllGraphicsResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allGraphicsLoading: state.clickedSubject.allLoading,
        fetchAllGraphicsResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchGraphics: () => dispatch( actions.fetchGraphics() ),

        onFetchAllGraphics: () => dispatch( actions.fetchAllGraphics() ),
...
Graphics.propTypes = {
    onFetchAllGraphics: PropTypes.func.isRequired,
