...
class Music extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchMusic();
        this.props.onFetchAllMusic();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allMusicLoading && !this.props.fetchAllMusicResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllMusicResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allMusicLoading: state.clickedSubject.allLoading,
        fetchAllMusicResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchMusic: () => dispatch( actions.fetchMusic() ),

        onFetchAllMusic: () => dispatch( actions.fetchAllMusic() ),
...
Music.propTypes = {
    onFetchAllMusic: PropTypes.func.isRequired,
