...
class Communication extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchCommunication();
        this.props.onFetchAllCommunication();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allCommunicationLoading && !this.props.fetchAllCommunicationResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllCommunicationResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allCommunicationLoading: state.clickedSubject.allLoading,
        fetchAllCommunicationResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchCommunication: () => dispatch( actions.fetchCommunication() ),

        onFetchAllCommunication: () => dispatch( actions.fetchAllCommunication() ),
...
Communication.propTypes = {
    onFetchAllCommunication: PropTypes.func.isRequired,
