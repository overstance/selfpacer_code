...
class Webdev extends Component {
   ...
   componentDidMount () {
        ...
        this.props.onFetchWebdev();
        this.props.onFetchAllWebdev();
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allWebdevLoading && !this.props.fetchAllWebdevResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllWebdevResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allWebdevLoading: state.clickedSubject.allLoading,
        fetchAllWebdevResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        onFetchWebdev: () => dispatch( actions.fetchWebdev() ),

        onFetchAllWebdev: () => dispatch( actions.fetchAllWebdev() ),
...
Webdev.propTypes = {
    onFetchAllWebdev: PropTypes.func.isRequired,
