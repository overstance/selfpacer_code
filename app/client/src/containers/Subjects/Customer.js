...
class Customer extends Component {
   ...
   state = {
    ...
    render() {
        ...
        if ( !this.props.allCustomerLoading && !this.props.fetchAllCustomerResourcesError ) {
        ...
        <div>
            ...
            {all}
            {this.props.fetchAllCustomerResourcesError}
        </div>
...
const mapStateToProps = state => {
    return {
        ...
        allCustomerLoading: state.clickedSubject.allLoading,
        fetchAllCustomerResourcesError: state.clickedSubject.fetchAllResourcesError,
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onFetchAllCustomer: () => dispatch( actions.fetchAllCustomer() ),
...
Customer.propTypes = {
    onFetchAllCustomer: PropTypes.func.isRequired,
