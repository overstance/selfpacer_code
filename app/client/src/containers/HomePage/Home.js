            ...
            <div className={classes.pageWrapper}>
                ...
                <div className={classes.headerContainer}>
                    <div className={classes.header}>
                        ...
                        <div className={classes.userOrLoginIcon}>
                            { this.props.isAuthenticated && this.props.userName ?
                                <Link className={classes.userProfile} to='/profile'>
                    ...
                    <div className={classes.body}>
                        <div className={classes.logoWork}>
                            <div className={classes.logoAnimated}>
                                <svg id="homeLogoInitial_stroke" className={classes.homeLogoInitialStroke} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 266 72">
                                        ...
                                        <path className={classes.logoPowerRed} d="M33.477 19.264c.153 4.124 6.292 3.424 6.396-.469.114-4.266-6.402-3.645-6.396.469z"/>
